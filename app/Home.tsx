...
const demoResults=[
  {title:"Prověříme rušení a správné pásmo",text:"Pomalé načítání bývá nejčastěji způsobeno zarušeným pásmem 2,4 GHz od sousedů nebo nevhodným vysílacím kanálem. Průvodce vás navede, jak zařízení přepnout na 5 GHz nebo najít volný kanál."},
  {title:"Prověříme stabilitu linky a routeru",text:"Při náhodných výpadcích je klíčové zjistit, zda padá bezdrátový signál, nebo přívodní linka operátora. Průvodce vám ukáže jednoduchý test kontrolek a kabeláže."},
  {title:"Nejspíš jde o pokrytí a překážky",text:"Internet k routeru dorazí, ale signál slábne s každou zdí a překážkou. Průvodce nejdřív prověří umístění routeru a poradí bezplatné úpravy pozice dřív, než utratíte za nový hardware."},
  {title:"Prověříme 5 GHz pásmo a přenos pro streamování",text:"Video a chytrá televize vyžadují stabilní rychlost bez kolísání. Průvodce vám ukáže, jak oddělit pásma, omezit rušení nebo zařízení připojit optimální cestou."},
  {title:"Rozlišíme přípojku, router a koncové zařízení",text:"Pokud je problém specifický, průvodce postupně vyloučí chybu v poskytovateli, v routeru i v nastavení konkrétního zařízení a dovede vás k bezpečnému řešení."}
];
...
const quizQuestions=[
  {
    q:"Co vás nejvíc trápí?",
    options:[
      {text:"Pomalá Wi-Fi (načítání stránek a stahování)"},
      {text:"Wi-Fi vypadává a náhodně se odpojuje"},
      {text:"Slabý signál v patře nebo jiné místnosti"},
      {text:"Seká se TV nebo online video"},
      {text:"Jiný problém se sítí či zařízením"}
    ]
  },
  {
