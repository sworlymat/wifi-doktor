...
export default function Home({checkout}:{checkout?:string}){useEffect(()=>{
...
<div className="productMock"><div className="mockTop"><span className="mockLogo">W</span><span>Diagnostika</span><span className="stepPill">Ukázka postupu</span></div><div className="mockProgress"><i/></div><div className="mockBody"><span className="signal">⌁</span><p className="smallLabel">RYCHLÁ KONTROLA</p><h2>Kde Wi‑Fi<br/>zlobí nejvíc?</h2><div className="mockOption">Jen dál od routeru <span>→</span></div><div className="mockOption">Také blízko routeru <span>→</span></div><div className="mockOption">Jen na jednom zařízení <span>→</span></div><p className="safe">● Zatím nic neměníme. Nejdřív zjistíme příčinu.</p></div></div></section>
